...
//
//import io.bootify.my_app.dto.ErrorResponse;
//import io.bootify.my_app.dto.FieldError;
...
//        errorResponse.setException(exception.getClass().getSimpleName());
//        errorResponse.setMessage(exception.getMessage());
//        return new ResponseEntity<>(errorResponse, HttpStatus.valueOf(exception.getStatus().value()));
//    }
//
